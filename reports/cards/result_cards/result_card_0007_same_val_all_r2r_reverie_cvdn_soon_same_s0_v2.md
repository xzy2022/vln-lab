...
| R2R | val_seen | 80.22 | 74.36 | 2.11 | 86.58 | 80.27 | 72.29 | 79.13 | oracle_error=1.23m; action_steps=5.63; steps=6.01; lengths=11.99m |
...
| REVERIE | val_seen | 57.84 | 52.54 | 4.64 | 65.71 | 65.03 | 52.09 | 66.37 | oracle_error=2.56m; rgs=0.00; rgspl=0.00; action_steps=6.33; steps=7.57; lengths=14.61m; object grounding 扩展字段未激活 |
...
| CVDN | val_seen | 28.27 | 25.01 | 12.72 | 47.12 | 41.69 | 24.57 | 52.40 | oracle_path_success_rate=84.55; dist_to_end_reduction=9.06m; lengths=30.56m; path metrics 来自实验性补丁 |
| CVDN | val_unseen | 24.04 | 16.98 | 12.94 | 53.03 | 30.49 | 15.63 | 40.00 | oracle_path_success_rate=80.60; dist_to_end_reduction=6.76m; lengths=31.08m; path metrics 来自实验性补丁 |
| SOON | val_seen | 51.24 | 40.38 | 7.87 | 61.59 | 48.16 | 37.99 | 52.62 | oracle_error=4.00m; det_sr=0.00; det_spl=0.00; action_steps=12.29; steps=18.52; lengths=33.09m; detection 扩展字段未激活; path metrics 来自实验性补丁 |
| SOON | val_unseen | 36.34 | 25.66 | 8.13 | 54.01 | 36.81 | 21.52 | 42.42 | oracle_error=4.52m; det_sr=0.00; det_spl=0.00; action_steps=12.68; steps=17.65; lengths=34.75m; detection 扩展字段未激活; path metrics 来自实验性补丁 |
...
|---|---:|---:|---:|---|
| eval(all 10 splits) | 1832.26 |  | 0.116 s/sample | 15747 条结果; 包含模型加载、图构建与最短路预处理 |
...
- 诊断价值：相较 `0005`，本次补齐了 R2R/REVERIE 的 `val_seen`、CVDN/SOON 的 `val_seen`，并通过实验性 evaluator 改动输出了 CVDN/SOON 的 nDTW、SDTW、CLS；这些新增项适合做内部诊断，暂不应写成官方论文复现对照。
...
- Comparison 只填写论文里已有且与当前主线口径一致的官方参考项；其余空白并不表示实验没有产出，而是当前没有可靠对照基线，或该指标属于未激活/实验性的扩展字段。
- CVDN/SOON 的 nDTW、SDTW、CLS 来自 `patches/same/experimental/0003-cvdn-soon-path-metrics.patch` 对 evaluator 的扩展，后续若进入长期论文对照，需要先固定该补丁口径并补充单元测试/文档说明。
