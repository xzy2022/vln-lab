...
```
┌─────────┬────────────┬────────────┬────────────┬────────────┬────────────┬──────────────┐
│ Skill   │ SAME SR    │ NavGPT SR  │ SAME vs NG │ Same σ     │ Pattern    │ Evidence Gap │
├─────────┼────────────┼────────────┼────────────┼────────────┼────────────┼──────────────┤
│ DC      │ TBD        │ TBD        │ TBD        │ TBD        │ TBD        │ TBD          │
│ NU      │ TBD        │ TBD        │ TBD        │ TBD        │ TBD        │ TBD          │
│ LR      │ TBD        │ TBD        │ TBD        │ TBD        │ TBD        │ TBD          │
│ RR      │ TBD        │ TBD        │ TBD        │ TBD        │ TBD        │ TBD          │
│ VM      │ TBD        │ TBD        │ TBD        │ TBD        │ TBD        │ TBD          │
│ Mix     │ TBD        │ TBD        │ TBD        │ TBD        │ TBD        │ TBD          │
└─────────┴────────────┴────────────┴────────────┴────────────┴────────────┴──────────────┘
```
...
- [ ] A.1：确认 SAME 在 NavNuances 数据集上的评估接口
